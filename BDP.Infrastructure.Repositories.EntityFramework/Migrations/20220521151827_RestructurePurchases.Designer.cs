...
namespace BDP.Infrastructure.Repositories.EntityFramework.Migrations
{
    ...
    [Migration("20220521151827_RestructurePurchases")]
    partial class RestructurePurchases
    {
            ...
            modelBuilder.Entity("BDP.Domain.Entities.ProductOrder", b =>
                {
                    ...
                    b.HasOne("BDP.Domain.Entities.Product", "Item")
                        .WithMany()
            ...
            modelBuilder.Entity("BDP.Domain.Entities.ServiceReservation", b =>
                {
                    ...
                    b.HasOne("BDP.Domain.Entities.Service", "Item")
                        .WithMany()
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
